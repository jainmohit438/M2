...
public class customer_confirm extends ArrayAdapter<appointment> {


    private Activity cont;
    private List<appointment> a1;

    public customer_confirm(Activity context, List<appointment> alist) {
    ...
    public View getView(int pos, View convert, ViewGroup par) {
        ...
        appointment a = a1.get(pos);

        tv_wrk.setText(a.getWork());
        tv_wname.setText(a.getWorker());
